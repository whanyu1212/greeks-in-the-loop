...
| --- | --- |
| Contract compliance | Reuses the existing report, decision, preliminary-research, and intent schemas; checks that the report, retained record, and terminal outcome agree. |
